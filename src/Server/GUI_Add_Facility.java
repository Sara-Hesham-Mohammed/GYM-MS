...
public class GUI_Add_Facility extends javax.swing.JFrame {

    private Admin a ;

    public GUI_Add_Facility() {
        initComponents();
    }

    public GUI_Add_Facility(Admin a) {
        this.a = a;
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_Add_Facility.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_Add_Facility().setVisible(true);
            }
        });
    }
